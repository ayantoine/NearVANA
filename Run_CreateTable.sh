...
echo "------ Create table ------"
	...
	$SCALL $SPARAM $SRENAME ${PID}_NTable -e Creation_TableAll.e -o Creation_TableAll.o ${SDIR}/CreateTableFusion.sh $ARG ${nb_jobs}
	...
	rm ${PID}.creationN.ok ${PID}.creationX.ok
echo "------ /Create table ------"
